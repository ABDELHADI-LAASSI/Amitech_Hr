...
class RejectRetardManager(models.TransientModel):
    _name = 'demande.retard.reject.manager.wizard'
    ...
    def action_reject(self):
        ...
        leave_request = self.env['declaration.retard'].browse(self._context.get('active_id'))
...
class RejectRetardManager(models.TransientModel):
    _name = 'demande.retard.reject.hr.wizard'
